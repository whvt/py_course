...
def test_invalid_login(driver):
    ...
    error_message = login_page.find_element("css selector", ".error-message-container").text
    assert "Epic sadface" in error_message, "Error message not displayed for invalid credentials"
